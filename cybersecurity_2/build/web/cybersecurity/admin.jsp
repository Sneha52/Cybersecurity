      ...
      <div class="row">
       ...
       <%@ include file="sidebar.jsp"%>
          ...
          <div class="col-md-8" id="dv">
              ...
              <form class="needs-validation" novalidate action="fileupload.jsp" method="POST" enctype="multipart/form-data">
              <div class="jumbotron" style="margin-top: 50px;margin-right: 300px;margin-left: 50px">
               <h2 class="text-center" style="color: navy">NEWS UPDATE </h2><br/>
                <div class="form-group">
                    <div class="input-group">
                  
                        <input type="text" name="t" required class="form-control" placeholder="TITLE">
