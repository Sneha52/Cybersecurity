      ...
      <div class="modal-footer"><a href="login.jsp" class="btn btn-primary btn-block">Logout</a></div>
        ...
        <div class="row">
            <div class="col-md-2">
               ...
               <div class="col-md-2"><h1 style="padding-top: 30px;padding-left: 60px;font-size: 30px;color:  #072E5F">CONSULTS</h1>
                 
                    </div>
                <div class="col-md-7" style="margin-top: 110px;padding-left: 70px" id="dv">
        <%@include file="db.jsp" %>
        <%  
