...
while(rs.next()){
    java.sql.Date date=rs.getDate("date");
            ...
            %>
            <img style="margin-top: 50px;" src="images/<% out.println(rs.getString("image")); %>" width="250" height="250">
           <br/>
           <a href="editimg.jsp?id=<%out.println(request.getParameter("id"));%>">Edit image</a>
            <br/><br/>
            <form action="dbeditnews.jsp" method="POST">
                <input type="hidden" name="id" value="<%=request.getParameter("id")%>">
                
                <label style="font-size: 25px;"><b><input type="text" name="atname" value=" <% out.println(rs.getString("atname")); %>"></b></label><br/>
             <label style="font-size: 15px"><b><input type="date" name="date" value="<%=date %>"></b></label><br/>
             <label style="font-size: 15px;"><textarea name="atdesc"><% out.println(rs.getString("atdesc")); %></textarea>
                 <script>CKEDITOR.replace('atdesc');</script></label><br/>
