...
<html>
    ...
    <link rel="shortcut icon" href="favicon.png">
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
          <style>
            #dv{width: 800px;height: 700px;overflow: auto;
            padding-left: 50px;
            }
        </style>
      ...
      <div class="modal-footer"><a href="login.jsp" class="btn btn-primary btn-block">Logout</a></div>
        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <div class="col-md-2"><h1 style="padding-top: 30px;padding-left: 60px;font-size: 30px;color: #072E5F">NEWS</h1></div>
...
%>
   ...
   <td>
       <a href="newsmore.jsp?id= <%
           out.println(rs.getString("id"));%>"><i  href="newsmore.jsp" class="icofont icofont-ui-search"></i></a>
   </td>
   <td>
       <a href="newsedit.jsp?id=<%out.println(rs.getString("id"));%>" onclick="return confirm('Are you Sure?')"><i  href="newsedit.jsp" class="icofont icofont-edit"></i></a>
   </td>
           <td>
       <a href="deletenews.jsp?id=<%
...
<% count++;}
  %>
                ...
                </div><div class="col-md-1"><a href="admin.jsp" style="text-decoration: none;background-color:#072E5F ;border-radius: 10%;color:white; font-size:20px;margin-top: 30px;padding-left: 10px;padding-right: 10px">Add</a></div></div>
    </body>
</html>
