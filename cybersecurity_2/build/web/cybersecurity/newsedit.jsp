...
while(rs.next()){
            ...
            %>
            <img style="margin-top: 50px;" src="images/<% out.println(rs.getString("fname")); %>" width="250" height="250">
           <br/>
           <a href="editimg1.jsp?id=<%out.println(request.getParameter("id"));%>">Edit image</a>
            <br/><br/>
            
            <form action="dbnewsedit.jsp" method="POST">
                <input type="hidden" name="id" value="<%=request.getParameter("id")%>">
                
                <label style="font-size: 25px;"><b><input type="text" name="title" value=" <% out.println(rs.getString("title")); %>"></b></label><br/>
             
             <label style="font-size: 15px;"><textarea name="description"><% out.println(rs.getString("description")); %></textarea>
                 <script>CKEDITOR.replace('description');</script></label><br/>
