           ...
           <div class="row">
            ...
            <div class="col-md-2"></div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="p" required class="form-control" placeholder="enter password" id="pass2">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="p1"  required class="form-control" placeholder="confirm password" id="pass2">
