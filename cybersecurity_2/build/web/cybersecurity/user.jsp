      ...
      <div class="modal-footer"><a href="login.jsp" class="btn btn-primary btn-block">Logout</a></div>
        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <div class="col-md-2"><h1 style="padding-top: 30px;padding-left: 60px;font-size: 30px;color: #072E5F">USERS</h1></div>
...
while(rs.next()){ %>
  ...
  out.println(rs.getString("first_name")); %></td><td>
        ...
        <% out.println(rs.getString("phone_no")); %></td>
    <td>
       <a href="delete.jsp?email=<%
           out.println(rs.getString("email"));%>" onclick="return confirm('Are you Sure?')"> <i class="icofont icofont-ui-delete"></i> </a>
    </td>
        </td></tbody>
</tr>
<%}
  %>
                ...
                </div><div class="col-md-1"><a href="register.jsp" style="text-decoration: none;background-color:#072E5F ;border-radius: 10%;color:white; font-size:20px;margin-top: 30px;padding-left: 10px;padding-right: 10px">Add</a></div></div>
    </body>
</html>
