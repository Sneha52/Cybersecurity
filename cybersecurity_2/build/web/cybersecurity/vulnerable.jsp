      ...
      <div class="row">
       ...
       <%@ include file="sidebar1.jsp"%>
          ...
          <div class="col-md-8">
              ...
              <form class="needs-validation" novalidate action="vulnerablescan.jsp" method="POST" >
              <div class="jumbotron" style="margin-top: 50px;margin-right: 300px;margin-left: 50px">
               <h2 class="text-center" style="color:  #008080">VULNERABLE SCAN </h2><br/>
                
                <div class="form-group">
                    <div class="input-group">
                  
                        <input type="text" name="w" required class="form-control" placeholder="Enter Website">
