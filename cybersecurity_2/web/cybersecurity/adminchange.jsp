  ...
  <div class="modal-dialog modal-sm">
      ...
      <div class="row">
       ...
       <%@ include file="sidebar.jsp"%>
        ...
        <form class="needs-validation" novalidate action="main7.jsp" method="POST">
        <div class="row">
         
            <div class="col-md-8" style="padding-top:100px">
                <h2 style="color:#072E5F;font-size: 35px" class="text-center "><b></b>CHANGE PASSWORD </h2><br/>
                <div class="form-group">
                    <div class="input-group">
                     
                    <input type="text" name="op" required class="form-control" placeholder="Enter Old Password">
                ...
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" name="np" required class="form-control"  placeholder="Enter New Password">
                         <div class="valid-feedback">valid</div>
                       <div class="invalid-feedback">invalid</div>
                 ...
                 <div class="form-group">
                    <div class="input-group">
                        <input type="text" name="cp" required class="form-control"  placeholder="Confirm Password">
                         <div class="valid-feedback">valid</div>
                       <div class="invalid-feedback">invalid</div>
                        <div class="input-group-append"></div>
                    </div>
