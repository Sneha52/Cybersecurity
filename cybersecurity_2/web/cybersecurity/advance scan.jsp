      ...
      <div class="row">
       ...
       <%@ include file="sidebar1.jsp"%>
          ...
          <div class="col-md-8">
              ...
              <form class="needs-validation" novalidate action="scan2.jsp" method="POST">
              <div class="jumbotron" style="margin-top: 50px;margin-right: 300px;margin-left: 50px">
               <h2 class="text-center" style="color:  #008080">ADVANCE SCAN </h2><br/>
               ...
               <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="number" name="t" required class="form-control" placeholder="Enter Start port no" min="1" max="65534">
                         <div class="valid-feedback">valid</div>
                       <div class="invalid-feedback">invalid</div>
                    </div>
                </div>
               <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="number" name="e" required class="form-control" placeholder="Enter End port no" min="1" max="65535">
                         <div class="valid-feedback">valid</div>
                       <div class="invalid-feedback">invalid</div>
                    </div>
                </div>
