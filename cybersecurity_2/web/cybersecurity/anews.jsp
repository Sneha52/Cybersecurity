  ...
  <div class="modal-dialog modal-sm">
      ...
      <%@include file="sidebar.jsp" %>
          ...
          <div class="col-md-8" id="dv">
              <form class="needs-validation" novalidate action="anewsupload.jsp" method="POST" enctype="multipart/form-data">
             
                  <div class="jumbotron" style="margin-top: 50px;margin-right: 300px;margin-left: 50px">
                      <h2 class="text-center" style="color:navy"><b>ATTACK NEWS</b></h2><br/>
                <div class="form-group">
                    <div class="input-group">
                        
                        <input type="text" name="t2" required class="form-control" placeholder="Name">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="da" required class="form-control">
                    <div class="valid-feedback">valid</div>
                       <div class="invalid-feedback">invalid</div>
                    </div></div>
