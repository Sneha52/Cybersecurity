     ...
     <%@include file="header.jsp"%>
       ...
       <div class="row pt-5 pb-4"style="padding-left:80px" >
        ...
        %>
            ...
            <div class="col-md-3" style="border:threedface ; border-style:solid; border-radius:10px; background-color: white;border-color: white">
                
                <video src="videos/<%out.println(rs.getString("avideo"));%>" width="290" height="200"  controls="controls"></video><hr/>
                 
                
              <b> Name:</b> <%out.println(rs.getString("aname"));%><br>
             
              <br>
                
                
                
                              <a href="attackmore1.jsp?id=<%
