  ...
  <div class="modal-dialog modal-sm">
      ...
      <%@include file="sidebar.jsp" %>
          ...
          <div class="col-md-8" id="dv">
              <form class="needs-validation" novalidate action="attackupload.jsp" method="POST" enctype="multipart/form-data">
             
                  <div class="jumbotron" style="margin-top: 50px;margin-right: 300px;margin-left: 50px">
                      <h2 class="text-center" style="color:navy"><b>ATTACKS</b></h2><br/>
                <div class="form-group">
                    <div class="input-group">
                        
                        <input type="text" name="t1" required class="form-control" placeholder="TITLE">
                 ...
                 <div class="form-group">
                    <div class="input-group">
                        <textarea name="d1" rows="4" required class="form-control" placeholder="DESCRIPTION"> </textarea>
                        <script> CKEDITOR.replace('d1');</script>
                         <div class="valid-feedback">valid</div>
                       <div class="invalid-feedback">invalid</div>
                    ...
                    <div class="input-group">
                        ...
                        <textarea name="p1" required rows="2" class="form-control" placeholder="PRECAUTIONS"></textarea>
                         <script> CKEDITOR.replace('p1');</script>
                         <div class="valid-feedback">valid</div>
                       <div class="invalid-feedback">invalid</div>
                        <div class="input-group-append"></div>
                    </div>
