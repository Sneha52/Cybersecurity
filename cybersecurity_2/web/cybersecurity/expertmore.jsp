...
String sql ="Select * from expert where id = "+request.getParameter("id");
ResultSet rs=stmt.executeQuery(sql);
while(rs.next()){

            %>
            <img src="images/<% out.println(rs.getString("picture")); %>" width="250" height="250" style="margin-top: 20px">
            <br/><br/>
      
            <label style="font-size: 25px;"><b>  <% out.println(rs.getString("name")); %></b></label><br/>
            <label style="font-size: 15px;"><% out.println(rs.getString("email")); %></label><br/>
            <label style="font-size: 15px;"><% out.println(rs.getString("phone_no")); %></label><br/>
